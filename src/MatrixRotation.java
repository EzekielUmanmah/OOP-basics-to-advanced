...
public class MatrixRotation {
    ...
    private static double[][] generateMatrix(int size) {
        ...
        for (int i = 0; i < matrix.length; i++) {
            for (int j = 0; j < matrix.length; j++) {
                matrix[i][j] = Double.parseDouble(Integer.toString(i) + "." + Integer.toString(j));
            }
        }
        return matrix;
    }
    ...
    public static void rotate90(double[][] matrix) {
        for (int i = 0; i < matrix.length; i++) {
            for (int j = 0; j < matrix.length; j++) {
                matrix[i][j] = Double.parseDouble(Integer.toString(matrix.length - j - 1) + "." + Integer.toString(i));
            }
        }
    }
    ...
    public static void rotate180(double[][] matrix) {
        for (int i = 0; i < matrix.length; i++) {
            for (int j = 0; j < matrix.length; j++) {
                matrix[i][j] =
                        Double.parseDouble(Integer.toString(matrix.length - 1 - i) + "." + Integer.toString(matrix.length - j - 1));
            }
        }
    }
    ...
    public static void rotate270(double[][] matrix) {
        for(int i = 0; i < matrix.length; i++){
            for(int j = 0; j < matrix.length; j++){
                matrix[i][j] = Double.parseDouble(Integer.toString(j) + "." + Integer.toString(matrix.length - 1 - i));
            }
        }
    }
